...
Write a function that accepts an object and an integer as arguments and adds a new property to the object called yearBorn. The value of the yearBorn property should be the integer
that was passed in.
...
const addBirthYearProperty = (obj, year) => {
  // Solution code here...
  obj.yearBorn = year
  console.log(obj,"SSDSDSDSDSDSDSDSDSDSDS")
};
