...
For example, ['this is great :)', 'wow', 'whyyyyyy :(', ':)))))'] returns
['t', 'w', 'w', ':']
------------------------------------------------------------------------------------------------ */
...
returns an array containing only the strings from the input array that
 contain ":)".
...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  return arr.map(phoneNumber => phoneNumber.split(/[^\d]/).join(''));
};
